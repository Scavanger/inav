...
| dji_cn_alternating_duration | 30 | Alternating duration of craft name elements, in tenths of a second |
| dji_esc_temp_source | ESC | Re-purpose the ESC temperature field for IMU/BARO temperature |
| dji_gps_speed_source | GROUND | Sets the speed type displayed by the DJI OSD: GROUND, 3D, AIR |
| dji_message_speed_source | 3D | Sets the speed type displayed by the DJI OSD in craft name: GROUND, 3D, AIR |
| dji_rssi_source | RSSI | Source of the DJI RSSI field: RSSI, CRSF_LQ |
| dji_use_adjustments | OFF | Show inflight adjustments in craft name field |
| dji_use_name_for_messages | ON | Re-purpose the craft name field for messages. |
